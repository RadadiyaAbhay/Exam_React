...
import { addStudent } from '../../services/actions/student.action'
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-7 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <button type='submit' className='shadow-md rounded-xl px-5 py-2 font-bold text-white bg-gray-900'>Submit</button>
                                </div>
                            </div>
                        </div>
                    </form>
